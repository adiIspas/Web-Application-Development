<%@ Page Title="" Language="C#" MasterPageFile="~/Head.master" AutoEventWireup="true" CodeFile="Update.aspx.cs" Inherits="Update" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <h2>Actualizeaza o planificare pentru asflatare</h2>
</asp:Content>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="noul_cost" runat="server"></asp:TextBox>

                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="noul_cost" ErrorMessage="Costul trebuie sa fie intreg!" ValidationExpression="^[+]?\d+([.]\d+)?$" Display="Dynamic"></asp:RegularExpressionValidator>

                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="noul_cost" Display="Dynamic" ErrorMessage="Cost lipsa!"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Calendar ID="noua_data" runat="server"></asp:Calendar>
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:Button ID="modifica" runat="server" OnClick="Button1_Click" Text="Modifica date planificare" Width="191px" />
